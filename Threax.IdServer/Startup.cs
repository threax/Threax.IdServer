    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IToolRunner>(s =>
            {
                ...
                .AddTool("changePassword", new ToolCommand("Change the password for the given user guid or e-mail. This is interactive and will prompt for the password if one is not provided.", async a =>
                {
                    var toolController = a.Scope.ServiceProvider.GetRequiredService<ChangePassword>();
                    await toolController.Run(a.Args[0], a.Args.Count > 1 ? a.Args[1] : null);
                }))
                .AddTool("unlockAccount", new ToolCommand("Unlock the account for the given user guid or e-mail.", async a =>
                {
