...
namespace Threax.IdServer.Client
{
    ...
    public partial class ClientEditModel 
    {
        ...
        [Newtonsoft.Json.JsonProperty("allowedGrantTypes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore, ItemConverterType = typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
    ...
    public partial class ClientEditModelCollectionView 
    {
        ...
        [Newtonsoft.Json.JsonProperty("grantTypes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore, ItemConverterType = typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
